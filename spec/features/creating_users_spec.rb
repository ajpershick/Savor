...
feature "get new_user" do
  it "Creates a new user and displays them in admin/index" do
    ...
    within('#create_account', visible: false) do
      fill_in 'Username', with: @admin.username, :match => :prefer_exact
      fill_in 'First Name', with: @admin.name, :match => :prefer_exact
    ...
    expect(page).to have_selector("td", text: @admin.username, visible: true)
  end
end